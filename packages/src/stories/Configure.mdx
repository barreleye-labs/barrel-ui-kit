...
<div className="sb-container">
  ...
  <div className="sb-section">
    ...
    <div className="sb-section-item">
      ...
      <p className="sb-section-item-paragraph">Often when a story doesn't render, it's because your component is expecting a specific environment or context (like a muiTheme provider) to be available.</p>
      <a
